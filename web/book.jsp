        ...
        try
            {
                ...
                PreparedStatement ps2= cn.prepareStatement("select * from HOTEL where email=?");
                ps2.setString(1, hemail);
                ...
                int hid=0;
                 ...
                 {
                     hid = rs1.getInt("H_ID");
                  b=rs1.getString("H_NAME");
                  c=rs1.getString("EMAIL");
                  d=rs1.getString("PHONE_NO");
                  m=rs1.getString("STATE");
                  i=rs1.getString("CITY");
                  j=rs1.getString("LOCATION");
                  t=rs1.getString("ADDRESS");
                  l=rs1.getString("PINCODE");
                ...
                PreparedStatement ps3 = cn.prepareStatement("insert into BOOKING values(?,?,?)");
